...
public class Match_Data {
    private String uploadDate, uploadTime,referId,matchCharge,slots,matchTime,matchDate,imageUrl,matchCategory,matchDuration,room_Id,room_pass,reward;

    public Match_Data() {
    }

    public Match_Data(String uploadDate, String uploadTime, String referId, String matchCharge, String slots, String matchTime, String matchDate, String imageUrl, String matchCategory, String matchDuration, String room_Id, String room_pass, String reward) {
